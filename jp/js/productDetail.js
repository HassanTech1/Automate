...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const products = {
    'ai-analytics': {
      ...
      description: '機械学習による高度なデータ分析で、ビジネスデータから実用的なインサイトを抽出します。',
      ...
      features: [
        {
          title: 'リアルタイム分析',
          description: 'リアルタイムでデータを処理・分析し、即時のインサイトと実用的な情報を提供します。',
        ...
        {
          title: '高度な可視化',
          description: 'インタラクティブなグラフやチャートでカスタムダッシュボードを作成し、データを効果的に可視化します。',
          icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
        ...
        {
          title: '予測分析',
          description: '機械学習アルゴリズムで過去データから傾向や結果を予測します。',
          icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
        ...
        {
          title: 'セキュリティ分析',
          description: 'データ内の異常パターンや外れ値を自動検出し、迅速に問題へ対応します。',
          icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
    ...
    'nlp-engine': {
      title: '自然言語処理エンジン',
      description: '最先端のNLPソリューションで人間の言語を理解・解釈・生成します。',
      ...
      features: [
        {
          title: '感情分析',
          description: '言葉の背後にある感情を判定し、顧客の態度や意見を把握します。',
          icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
        ...
        {
          title: 'テキスト分類',
          description: 'テキストを自動的にカテゴリ分けし、データを整理・構造化します。',
          icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
        ...
        {
          title: '固有表現抽出',
          description: 'テキストから人名・組織名・地名・日付などの固有表現を抽出します。',
          icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
        ...
        {
          title: '会話型AI',
          description: '自然言語を理解し応答できるインテリジェントなチャットボットやバーチャルアシスタントを構築します。',
          icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
