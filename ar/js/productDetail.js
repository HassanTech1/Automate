...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const products = {
    'ai-analytics': {
      title: 'أوبرافلو لإدارة الموارد البشرية والشركات',
      description: 'تحليل بيانات متقدم مدعوم بتعلم الآلة لاستخلاص رؤى قابلة للتنفيذ من بيانات عملك.',
      ...
      features: [
        {
          title: 'تحليلات الوقت الحقيقي',
          description: 'معالجة وتحليل البيانات في الوقت الفعلي لتوفير رؤى فورية ومعلومات قابلة للتنفيذ.',
        ...
        {
          title: 'تصورات متقدمة',
          description: 'إنشاء لوحات تحكم مخصصة مع رسوم بيانية وتفاعلية لعرض بياناتك بفعالية.',
          icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
        ...
        {
          title: 'تحليل تنبؤي',
          description: 'استخدام خوارزميات تعلم الآلة للتنبؤ بالاتجاهات والنتائج بناءً على البيانات التاريخية.',
          icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
        ...
        {
          title: 'تحليل الأمان',
          description: 'تحديد الأنماط غير المعتادة والشذوذ في بياناتك تلقائيًا لمعالجة المشكلات بسرعة.',
          icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
    ...
    'nlp-engine': {
      title: 'محرك معالجة اللغة الطبيعية',
      description: 'فهم وتفسير وتوليد اللغة البشرية باستخدام حلول معالجة اللغة الطبيعية المتقدمة لدينا.',
      ...
      features: [
        {
          title: 'تحليل المشاعر',
          description: 'تحديد النبرة العاطفية وراء الكلمات لفهم مواقف وآراء العملاء.',
          icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
        ...
        {
          title: 'تصنيف النصوص',
          description: 'تصنيف النصوص تلقائيًا ضمن فئات محددة مسبقًا لتنظيم البيانات.',
          icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
        ...
        {
          title: 'استخراج الكيانات المسماة',
          description: 'تحديد واستخراج الكيانات مثل الأسماء والمنظمات والمواقع والتواريخ من النص.',
          icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
        ...
        {
          title: 'ذكاء المحادثة',
          description: 'بناء روبوتات دردشة ومساعدين افتراضيين أذكياء يمكنهم فهم اللغة الطبيعية والرد عليها.',
          icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
    ...
    'cv-platform': {
      title: 'منصة الرؤية الحاسوبية',
      description: 'تمكين الآلات من رؤية وفهم المعلومات البصرية باستخدام أدوات الرؤية الحاسوبية القوية لدينا.',
      ...
      features: [
        {
          title: 'اكتشاف الأجسام',
          description: 'تحديد وتحديد مواقع الأجسام داخل الصور والفيديوهات بدقة عالية.',
          icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  <path d="M21 14l-9 6-9-6" stroke-width="2"/>
                  <path d="M3 10l9 6 9-6" stroke-width="2"/>
                  <path d="M3 6ل9 6 9-6" stroke-width="2"/>
                </svg>`
        },
        {
          title: 'التعرف على الوجوه',
          description: 'اكتشاف وتحليل وتحديد الوجوه البشرية للتطبيقات الأمنية والشخصية.',
          icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  ...
                  <path د="M5 14v6" stroke-width="2"/>
                </svg>`
        },
        {
          title: 'تجزئة الصور',
          description: 'تقسيم الصور إلى أجزاء ذات معنى لتحليل ومعالجة أكثر تفصيلاً.',
          icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  ...
                  <path د="M19.5 14H14v5.5h5.5V14z" stroke-width="2"/>
                </svg>`
        },
        {
          title: 'مراقبة الجودة',
          description: 'اكتشاف العيوب تلقائيًا وضمان الجودة في عمليات التصنيع والإنتاج.',
          icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  <path d="M22 12l-4 4-1.5-1.5" stroke-width="2"/>
                  <path d="M22 6l-4 4-1.5-1.5" stroke-width="2"/>
                  <path د="M22 18l-4 4-1.5-1.5" stroke-width="2"/>
                  <path د="M2 12h13" stroke-width="2"/>
                  <path د="M2 6h13" stroke-width="2"/>
                  <path د="M2 18h13" stroke-width="2"/>
                </svg>`
        }
      ]
    },
    'ai-automation': {
      ...
      description: 'أتمتة المهام المتكررة وسير العمل باستخدام روبوتات ذكية تتعلم وتتحسن مع الوقت.',
      ...
      features: [
        {
          ...
          description: 'أتمتة العمليات التجارية المتكررة لزيادة الكفاءة وتقليل العمل اليدوي.',
          icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  <path d="M16 18l2-2-2-2" stroke-width="2"/>
                  <path د="M10 6L8 8l2 2" stroke-width="2"/>
                  <path د="M18 16h-5a2 2 0 01-2-2v-4" stroke-width="2"/>
                  <path د="M8 8H5a2 2 0 00-2 2v4a2 2 0 002 2h3" stroke-width="2"/>
                </svg>`
        },
        {
          title: 'معالجة المستندات الذكية',
          description: 'استخراج ومعالجة المعلومات من المستندات والنماذج والصور بدقة عالية.',
          icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  <path د="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8l-6-6z" stroke-width="2"/>
                  <path د="M14 2v6h6" stroke-width="2"/>
                  <path د="M16 13H8" stroke-width="2"/>
                  <path د="M16 17H8" stroke-width="2"/>
                  <path د="M10 9H8" stroke-width="2"/>
                </svg>`
        },
        {
          title: 'دعم اتخاذ القرار',
          description: 'تحليل مدعوم بالذكاء الاصطناعي للمساعدة في اتخاذ قرارات تجارية مستنيرة بناءً على البيانات.',
          icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  <path د="M12 3v6m0 12v-6" stroke-width="2"/>
                  <path د="M3 12h6m12 0h-6" stroke-width="2"/>
                  <path د="M12 20a8 8 0 100-16 8 8 0 000 16z" stroke-width="2"/>
                </svg>`
        },
        {
          title: 'تشغيل آلي على مدار الساعة',
          description: 'تشغيل مستمر بدون تدخل بشري لزيادة الإنتاجية والكفاءة.',
          icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  <path د="M12 2v4" stroke-width="2"/>
                  <path د="M6.34 4.34L9.17 7.17" stroke-width="2"/>
                  <path د="M4 12H2" stroke-width="2"/>
                  <path د="M6.34 19.66l2.83-2.83" stroke-width="2"/>
                  <path د="M12 22v-2" stroke-width="2"/>
                  <path د="M17.66 19.66l-2.83-2.83" stroke-width="2"/>
                  <path د="M22 12h-2" stroke-width="2"/>
                  <path د="M17.66 4.34l-2.83 2.83" stroke-width="2"/>
                  <path د="M22 12a10 10 0 00-10-10" stroke-width="2"/>
                </svg>`
        }
      ]
    }
  ...
  document.title = `${product.title} - أوبرتريكس`;
  ...
  if (enterpriseLabel) {
    enterpriseLabel.textContent = 'مخصص';
  }
